...
void ROIAlignRotatedForward(const int nthreads,  const scalar_t *bottom_data,
    ...
    for (int index=0; index<nthreads; index++)
    {
      ...
      // std::cout << offset_bottom_rois[0] << std::endl;
      // std::cout << roi_batch_ind << std::endl;
      ...
      // std::cout << "roi_width:" << roi_width << ',' << "ss:" <<  spatial_scale << std::endl;
      ...
      // std::cout << "(roi_start_w, bin_size_w, roi_bin_grid_w):" << roi_start_w << "," << bin_size_w << ',' << roi_bin_grid_w << std::endl;
                                ...
                                at::Tensor output) 
  {
    ...
    AT_DISPATCH_FLOATING_TYPES(
        features.scalar_type(), "ROIAlignRotatedLaucherForward", ([&] {
            ...
            std::cout << spatial_scale << std::endl;
